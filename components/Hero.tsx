...
export function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute left-[-10%] top-20 h-72 w-72 rounded-full bg-primary/15 blur-3xl pointer-events-none animate-float-slow" />
      <div className="absolute right-[-12%] bottom-10 h-80 w-80 rounded-full bg-cyan-400/10 blur-3xl pointer-events-none animate-pulse-glow" />
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto animate-fade-in-up">
        <div className="mb-6 flex flex-wrap items-center justify-center gap-3 text-xs font-medium uppercase tracking-[0.25em] text-primary/90">
          <span className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-2 animate-float-slow">
        ...
        <div className="mb-10 flex flex-wrap items-center justify-center gap-3 opacity-0 animate-fade-in animation-delay-400">
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card/70 px-4 py-2 text-sm text-foreground animate-fade-in-up animation-delay-400">
            <Briefcase className="h-4 w-4 text-primary" />
            {personalInfo.role}
          </span>
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card/70 px-4 py-2 text-sm text-foreground animate-fade-in-up animation-delay-500">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center opacity-0 animate-fade-in animation-delay-500">
          <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg group shine-on-hover hover-lift-glow">
            <a
              href="/pdfs/cv/cv.pdf"
          ...
          <Button
            variant="outline"
            size="lg"
            className="px-8 py-6 text-lg border-primary text-primary hover:bg-primary hover:text-primary-foreground bg-transparent shine-on-hover hover-lift-glow"
